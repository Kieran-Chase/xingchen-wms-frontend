  ...
  <div>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        ...
        <a-button type="primary" v-auth="'warehouse:wms_storage_locations:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls">
          导出</a-button
        >
        <j-upload-button
          type="primary"
          v-auth="'warehouse:wms_storage_locations:importExcel'"
        ...
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'warehouse:wms_storage_locations:deleteBatch'"
            >批量操作
...
<!--        <super-query :config="superQueryConfig" @search="handleSuperQuery" />-->
    ...
    <!-- 表单区域 -->
    <WmsStorageLocationsModal @register="registerModal" @success="handleSuccess" />
  </div>
</template>
